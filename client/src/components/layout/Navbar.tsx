        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            ...
            <div className="ml-3 relative">
              <div>
                <button type="button" className="bg-white flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
